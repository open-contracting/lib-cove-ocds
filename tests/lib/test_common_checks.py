...
def test_get_releases_aggregates():
    ...
    with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'fixtures', 'common_checks', 'release_aggregate.json')) as fp: # noqa
        data = json.load(fp)
    ...
    with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'fixtures', 'common_checks', 'samplerubbish.json')) as fp: # noqa
        data = json.load(fp)
    ...
    with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'fixtures', 'common_checks', 'badfile.json')) as fp: # noqa
        data = json.load(fp)
